...
<style type="text/css">
    #video-section{
        ...
        background-image: url(plantilla/images/retroexcavadora.jpg);
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6 v_text_fondo_home">
                <h1 style="font-weight: 300;">RETROEXCAVADORA</h1>
            ...
            <div class="col-sm-6">                        
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="mobilization">
                        <img class="img-responsive" src="plantilla/images/cursos/retroexcavadora.jpg" alt="" />
                    </div>
                </div>
            </div>
            <div class="col-sm-12">
            ...
            <div class="col-sm-12">
                ...
                <div class="row" style="padding: 0px 0px 0px 20px; font-size: 17px">
                    <ul> 
                        ...
                        <li>7.- Certificado como Operador de Retroexcavadora con respaldo del MTC.</li>
