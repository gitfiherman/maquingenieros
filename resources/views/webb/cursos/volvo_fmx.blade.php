...
<style type="text/css">
    #video-section{
        ...
        background-image: url(plantilla/images/volvo_fmx.jpg);
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6 v_text_fondo_home">
                <h1 style="font-weight: 300;">VOLQUETE VOLVO FMX 440 - 480</h1>
                <p class="lead" >Especialízate y certifícate en operación de Volquete.</p>
            ...
            <div class="col-sm-6">                        
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="mobilization">
                        <img class="img-responsive" src="plantilla/images/cursos/volvo_fmx.jpg" alt="" />
                    </div>
                </div>
            </div>
            <div class="col-sm-12">
                ...
                <div class="row" style="padding: 0px 0px 0px 20px; font-size: 17px">
                    <ul> 
                        ...
                        <li>2.- Reconocer las partes del Camión Volquete Volvo.</li>
                        <li>3.- Desarrollar habilidades correspondientes a la operación de Camión Volquete Volvo.</li>
            ...
            <div class="col-sm-12">
                ...
                <div class="row" style="padding: 0px 0px 0px 20px; font-size: 17px">
                    <ul> 
                        ...
                        <li>7.- Certificado en Operación de Volquete Volvo FMX con respaldo del MTC.</li>
